    ...
    return (
        <>
            <div className="fixed top-0 left-0 w-full z-[100]">
                {showBanner1 && (
                    <div className="banner w-full hover:text-blue-700 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white py-2 px-4 flex items-center justify-between sm:justify-start lg:justify-center">
                ...
                {showBanner2 && (
                    <div className="banner w-full hover:text-blue-900 bg-blue-600 text-white py-2 px-4 flex items-center justify-between sm:justify-start lg:justify-center">
